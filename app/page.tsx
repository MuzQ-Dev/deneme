              ...
              {!showLogin ? (
                ...
                <div className="max-w-md mx-auto">
                  <div className="bg-white/95 backdrop-blur-xl border border-gray-200 rounded-2xl p-8 shadow-[0_20px_50px_rgba(0,0,0,0.1)]">
                    ...
                    {message && (
                      <div className={`mt-6 text-center p-4 rounded-lg ${message.startsWith('✓')
              ...
              <div className="inline-flex bg-gray-100/50 p-1.5 rounded-full border border-gray-200 backdrop-blur-sm">
                {['All', 'Mains', 'Breakfast', 'Side Dishes'].map((category) => (
                  <button
                    ...
                    className={`px-8 py-2.5 rounded-full text-sm font-bold transition-all duration-300 ${activeCategory === category
          ...
          <div className="max-w-7xl mx-auto px-6 text-center space-y-12">
            ...
            <div className="pt-6 text-center">
              <p className="text-white font-bold text-base md:text-lg tracking-wide">
                A company owned by SENBARLAS Limited
              </p>
            </div>
          </div>
        </footer>
